...
public class MainFragment extends ItemListFragment implements CommonAlertDialogFragment.Callback {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position) {
            ...
            case 12: {   // Tapped Barcode Reader row
            ...
            case 14: {   // Tapped Melody Speaker row
    ...
    private void updateList() {
        ...
        addMenu("LED Sample",                 isDeviceSelected && ModelCapability.canUsePresenter(modelIndex));
